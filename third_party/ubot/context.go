...
type Context struct {
	...
	callDisconnectCallbacks []func(chatId int64, reason string)
}
...
func (ctx *Context) OnCallDisconnect(callback func(chatId int64, reason string)) {
	ctx.callDisconnectCallbacks = append(ctx.callDisconnectCallbacks, callback)
}
